...
- ✅ **Dashboard Overview** - Quick stats and priority-based todo insights. The home view now merges Zettelkasten notes with an Eisenhower Matrix workspace by default, with a workspace toggle letting you switch to the Kanban board when you want lane-based prioritization:
  - Notes panel on the left for daily/recent zettels with search and tag filtering
